...
DECODER_EXPORTS="_decoder_open,_decoder_open_format,_decoder_open_file,_decoder_width,_decoder_height,_decoder_fps_num,_decoder_fps_den,_decoder_next_frame,_decoder_next_raw_frame,_decoder_seek,_decoder_close"
...
ENCODER_EXPORTS="_encoder_open,_encoder_open_audio,_encoder_push_rgba,_encoder_push_pcm,_encoder_finish,_encoder_output_ptr,_encoder_output_size,_encoder_close"
...
WEBGPU_EXPORTS="$COMMON_EXPORTS,_pipeline_run_rgba_gpu,_bench_scale_webgpu,_bench_scale_webgpu_session,_gpu_session_open,_gpu_session_run,_gpu_session_close"
