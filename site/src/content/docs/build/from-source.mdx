...
2. Activate it in **every** new shell before building (it doesn't persist):
...
in [codecs](/codecs/) an exact reflection of the preset rather than whatever FFmpeg ships
by default.
