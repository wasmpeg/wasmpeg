...
2. Decode a frame in a component. Loading the module and opening the decoder both happen in
...
```vue
<script setup>
import { useWasmpeg } from './useWasmpeg';
...
- [Decode video](/guides/decode-video/) · [Probe metadata](/guides/probe/) ·
  [Quick start](/start/quick-start/) · [Troubleshooting](/guides/troubleshooting/)
