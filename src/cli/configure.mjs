...
const PRESETS = {
    ...
    standard: {
        decoders:  ['h264', 'hevc', 'vp8', 'vp9', 'av1', 'aac', 'opus',
                    'mp3', 'mp2', 'vorbis', 'flac', 'ac3', 'eac3', 'dca', 'truehd',
                    'alac', 'wavpack', 'pcm_s16le', 'pcm_s24le', 'pcm_f32le', 'pcm_mulaw', 'pcm_alaw',
                    'adpcm_ms', 'adpcm_ima_wav', 'adpcm_ima_qt',
                    'png', 'mjpeg', 'mjpegb', 'gif', 'bmp', 'tiff', 'webp',
                    'mpeg1video', 'mpeg2video', 'mpeg4', 'h263',
                    'wmv1', 'wmv2', 'wmv3', 'vc1', 'msmpeg4v3',
                    'prores', 'dnxhd', 'huffyuv', 'ffv1',
                    'theora', 'vp3', 'vp6f', 'vp7',
                    'wmav1', 'wmav2', 'ape',
                    'amrnb', 'amrwb', 'gsm', 'gsm_ms', 'speex'],
        encoders:  ['aac', 'opus', 'flac', 'mjpeg', 'png', 'gif'],
        demuxers:  ['mov', 'matroska', 'avi', 'ogg', 'asf', 'flv', 'rm',
                    'mp3', 'wav', 'flac', 'aac', 'ac3', 'dts', 'truehd',
                    'amr', 'gsm',
                    'h264', 'hevc', 'vp8', 'vp9', 'av1',
                    'mpeg', 'mpegvideo', 'mpegts', 'm4v',
                    'mjpeg', 'gif', 'bmp', 'tiff',
                    'image2', 'image2pipe', 'image_png_pipe',
                    'concat', 'flac', 'pcm_s16le', 'pcm_mulaw', 'pcm_alaw'],
        muxers:    ['mp4', 'webm', 'ogg', 'image2', 'wav', 'null', 'flac'],
        parsers:   ['h264', 'hevc', 'vp8', 'vp9', 'av1', 'aac', 'opus', 'png',
                    'ac3', 'dca', 'flac', 'mpegaudio', 'mpeg4video'],
        protocols: ['file'],
        filters:   ['scale', 'crop', 'overlay', 'aresample', 'hstack', 'vstack', 'format',
