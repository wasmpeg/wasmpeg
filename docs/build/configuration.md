...
from FFmpeg's defaults, so the component list in [codecs](/docs/formats/codecs/) is exactly your preset.
...
{{< aside type="danger" title="The image-pipe naming trap" id="the-image-pipe-naming-trap" >}}
...
3. Relink — no FFmpeg rebuild needed (see the [incremental relink](/docs/build/from-source/#incremental-relink)).
